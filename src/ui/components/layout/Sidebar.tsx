...
const TOOLS_GUIDE = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          'Nhãn Zalo (Zalo Label): đồng bộ 2 chiều với app Zalo trên điện thoại — gán từ Raymond, thấy trên Zalo và ngược lại',
          'Nhãn Local: nhãn riêng của Raymond, tùy biến màu sắc + emoji, không giới hạn số lượng',
  ...
  },
  {
    ...
    purpose: 'Kết nối Raymond với hệ sinh thái bán hàng, thanh toán, vận chuyển Việt Nam. Tra cứu dữ liệu ngay trong khung chat, nhận webhook tự động, kết hợp Workflow để xử lý end-to-end.',
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Cho phép bên ngoài (Casso, SePay, n8n cloud...) gửi webhook về Raymond',
...
const COMBO_SCENARIOS = [
  {
    ...
    desc: 'Khách chuyển khoản → Raymond nhận webhook từ ngân hàng → Workflow tự động gửi tin xác nhận + gắn nhãn CRM.',
  },
  {
    icon: '🤖',
